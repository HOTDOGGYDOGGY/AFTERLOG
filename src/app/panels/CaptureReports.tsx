import { followUpText, isCaptureReport, totalsText } from "../../archive/captureReport";
    ...
    <section className="field">
      ...
      {list.map((r) => (
        <div key={r.jobId + r.exportedAt} className="report">
          ...
          {r.totals ? <p className="small">{totalsText(r.totals)}</p> : null}
          {r.followUp && followUpText(r.followUp) ? <p className="small">보완 필요: {followUpText(r.followUp)}</p> : null}
